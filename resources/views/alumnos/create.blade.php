...
<body class="container mt-5">
    ...
    <form action="{{ route('alumnos.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="apellido" class="form-control" id="apellido" value= "{{old('name')}}" required>
        </div>
        <div class="mb-3">
            <label for="email" class="form-label">Email Alumno*</label>
            <input type="text" name="email" class="form-control" id="email" value= "{{old('mail')}}" required>
        </div>
        <div class="mb-3">
